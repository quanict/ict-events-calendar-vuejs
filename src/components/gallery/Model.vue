<template>
    <div :class="className"
        id="exampleModalImage" aria-hidden="true">
        <div
            class="bg-white p-4 max-h-[calc(100vh-5rem)] overflow-auto rounded-lg w-10/12 lg:w-8/12 scale-95 transition-transform duration-300 ease-out">
                ...
                <div class="flex items-center gap-2">
                    <button
                        ...
                        <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.o rg/2000/svg" color="currentColor" class="h-4 w-4">
                            <path
