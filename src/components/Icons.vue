<template>
    <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" stroke-width="1.5" fill="none"
        xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4 hidden">
        <symbol id="files" stroke-width="1.5" fill="none">
        ...
        <symbol id="circle-user" stroke-width="1.5" fill="none">
            <path
...
<symbol id="box" stroke-width="1.5" fill="none">
    <path
...
<symbol id="print" stroke-width="1.5" fill="none">
...
<symbol id="bars" stroke-width="1.5" fill="none">
